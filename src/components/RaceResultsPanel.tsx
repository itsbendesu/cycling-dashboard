    ...
    <div className="rounded-lg border border-yellow-500/20 bg-yellow-500/5 p-4">
      ...
      {hasExpandable && (
        <button
          ...
          className="flex items-center gap-1.5 mt-4 ml-auto rounded-md border border-yellow-500/20 bg-yellow-500/10 px-3 py-1.5 text-xs font-medium text-yellow-700 dark:text-yellow-400 hover:bg-yellow-500/20 transition-colors"
        >
          <svg
